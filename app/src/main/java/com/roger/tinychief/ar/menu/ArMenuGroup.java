...
public class ArMenuGroup {
    ...
    public ArMenuGroup(ArMenuInterface menuInterface, Activity context, ArMenu parent, boolean hasTitle, String title, int width) {
        mActivity = context;
    ...
    public View addSelectionItem(String text, int command, boolean on) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            newView.setPadding(mEntriesSidesPadding + leftPadding, mEntriesUpDownPadding, mEntriesSidesPadding, mEntriesUpDownPadding);
    ...
    public View addRadioItem(String text, int command, boolean isSelected) {
        ...
        newRadioButton.setPadding(mEntriesSidesPadding, mEntriesUpDownRadioPadding, mEntriesSidesPadding, mEntriesUpDownRadioPadding);
