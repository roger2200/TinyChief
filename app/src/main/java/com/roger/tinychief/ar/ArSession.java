...
public class ArSession implements UpdateCallbackInterface {
    ...
    public ArSession(ArControl sessionControl) {
    ...
    public void initAR(Activity activity, int screenOrientation) {
        ...
        // ArSession needs to update the Projection Matrix.
        ...
        if (mInitVuforiaTask != null) {
            ...
            vuforiaException = new ArException(ArException.VUFORIA_ALREADY_INITIALIZATED, logMessage);
        ...
        if (vuforiaException == null) {
            try {
                ...
                vuforiaException = new ArException(ArException.INITIALIZATION_FAILURE, logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws ArException {
        String error;
        if (mCameraRunning) {
    ...
    public void stopAR() throws ArException {
        ...
        synchronized (mShutdownLock) {
            ...
            if (!unloadTrackersResult)
                throw new ArException(ArException.UNLOADING_TRACKERS_FAILURE, "Failed to unload trackers\' data");

            if (!deinitTrackersResult)
                throw new ArException(ArException.TRACKERS_DEINITIALIZATION_FAILURE, "Failed to deinitialize trackers");
            ...
            if (result) {
                ...
                if (initTrackersResult) {
                    try {
                        ...
                        vuforiaException = new ArException(ArException.LOADING_TRACKERS_FAILURE, logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }

                } else {
                    vuforiaException = new ArException(ArException.TRACKERS_INITIALIZATION_FAILURE, "Failed to initialize trackers");
                    mSessionControl.onInitARDone(vuforiaException);
                }
            } else {
                String logMessage;
